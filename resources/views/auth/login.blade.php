...
<head>
    ...
    <title>Login - Sarana Media Advertising</title>
    <style type="text/css">
        :host,
        :root {
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <div class="text-center">
                                        <img src="/sbadmin/assets/img/logo.png" style="height: 80px; margin: 0 auto;"
                                            class="mt-4" />
                                        <h4 class="font-weight-light my-4">Sarana Media Advertising
                                        </h4>
                                    </div>
                                </div>
                                <div class="card-body">
