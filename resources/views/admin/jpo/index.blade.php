...
@section('content')
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">JPO</li>
                                ...
                                <tbody>
                                    @forelse ($data as $b)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('editJpo', $b->id) }}">{{ $b->nama }}</a></td>
                                            <td>{{ $b->lokasi }}</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data JPO</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('addJpo') }}">
                        @csrf
                        <div class="row mb-2">
                            <div class="col">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea class="form-control" name="keteranganJpo" id="keteranganJpo"></textarea>
                        </div>
                        ...
                        <fieldset class="form-group row mb-2">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="tersedia" required
                                        value="Y">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="noTersedia" required
                                        value="N">
    ...
    <div class="modal fade" id="modalHapus" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Hapus Data JPO</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <hr />
                    <div class="pull-right">
                        <form action="{{ route('deleteJpo') }}" method="post">
                            @csrf
