...
@section('content')
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('billboard') }}">Billboard</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('updateBillboard') }}">
                            @csrf
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control" name="uketerangan" id="keteranganBillboard">{{ $data->detil }}</textarea>
                            </div>
                            ...
                            <div class="pull-right">
                                <a href="{{ route('billboard') }}" class="btn btn-secondary">Kembali</a>
